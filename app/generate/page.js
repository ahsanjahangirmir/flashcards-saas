...
import { Box, Button, Card, CardActionArea, CardContent, Container, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Grid, Paper, stepContentClasses, TextField, Typography } from "@mui/material"
                            ...
                            <Grid item xs={12} sm={6} md={4} key={id}>
                                <Card>
                                    <CardActionArea onClick={() => handleCardClick(id )}>
                                        <CardContent>
                                            <Box sx={{perspective:'1000px', '& > div': {transition: 'transform 0.6s', transformStyle:'preserve-3d', position:'relative', width:'100%', height:'200px', boxShadow:'0px 4px 8px 0px rgba(0,0,0,0.2)', transform: flipped[id] ? 'rotateY(180deg)' : 'rotateY(0deg)'}, '& > div > div': {position:'absolute', width:'100%', height:'100%', backfaceVisibility: 'hidden', display: 'flex', justifyContent: 'center', alignItems:'center', padding:2, boxSizing:"border-box "}, '& > div > div:nth-of-type(2)': {transform: 'rotateY(180deg)'}}}>
                                                <div>
                                                    <div>
